...
var LegacySidebarContext = React.createContext(void 0);
var useLegacySidebar = function() {
  var context = React.useContext(LegacySidebarContext);
  return context;
};
var useMediaQuery = function(breakpoint) {
  var _a = React.useState(!!breakpoint && typeof window !== "undefined" && window.matchMedia(breakpoint).matches), matches = _a[0], setMatches = _a[1];
...
var Sidebar = React.forwardRef(function(_a, ref) {
  ...
  var breakpointCallbackFnRef = React.useRef();
  ...
  var _g = React.useState(false), mounted = _g[0], setMounted = _g[1];
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(StyledSidebarContainer, { "data-testid": "".concat(sidebarClasses.container, "-test-id"), className: sidebarClasses.container, backgroundColor }, children),
      image && React.createElement(StyledSidebarImage, { "data-testid": "".concat(sidebarClasses.image, "-test-id"), src: image, alt: "sidebar background", className: sidebarClasses.image }),
      broken && toggledValue && React.createElement(StyledBackdrop, { "data-testid": "".concat(sidebarClasses.backdrop, "-test-id"), role: "button", tabIndex: 0, "aria-label": "backdrop", onClick: handleBackdropClick, onKeyPress: handleBackdropClick, className: sidebarClasses.backdrop })
    )
  );
});
...
var MenuContext = React.createContext(void 0);
var LevelContext = React.createContext(0);
...
var SubMenuContentFR = function(_a, ref) {
  ...
  var defaultOpenState = React.useState(defaultOpen)[0];
  return React.createElement(
...
var usePopper = function(options) {
  ...
  var _a = React.useContext(SidebarContext), collapsed = _a.collapsed, toggled = _a.toggled, transitionDuration = _a.transitionDuration;
...
var MenuButtonRef = function(_a, ref) {
  ...
  if (component) {
    if (typeof component === "string") {
      return React.createElement(component, __assign(__assign({ className: classnames(className) }, rest), { ref }), children);
    } else {
      var _b = component.props, classNameProp = _b.className, props = __rest(_b, ["className"]);
      return React.cloneElement(component, __assign(__assign(__assign({ className: classnames(className, classNameProp) }, rest), props), { ref }), children);
    }
  } else {
    return React.createElement("a", __assign({ ref, className: classnames(className) }, rest), children);
  }
};
var MenuButton = React.forwardRef(MenuButtonRef);
...
var SubMenuFR = function(_a, ref) {
  ...
  var _e = React.useContext(SidebarContext), collapsed = _e.collapsed, rtl = _e.rtl, sidebarTransitionDuration = _e.transitionDuration;
  ...
  var _h = React.useState(false), openWhenCollapsed = _h[0], setOpenWhenCollapsed = _h[1];
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      icon && React.createElement(StyledMenuIcon, { rtl, className: classnames(menuClasses.icon, sharedClasses), rootStyles: getSubMenuItemStyles("icon") }, icon),
      prefix2 && React.createElement(StyledMenuPrefix, { collapsed, transitionDuration: sidebarTransitionDuration, firstLevel: level === 0, className: classnames(menuClasses.prefix, sharedClasses), rtl, rootStyles: getSubMenuItemStyles("prefix") }, prefix2),
      React.createElement(StyledMenuLabel, { className: classnames(menuClasses.label, sharedClasses), rootStyles: getSubMenuItemStyles("label") }, label),
      suffix && React.createElement(StyledMenuSuffix, { collapsed, transitionDuration: sidebarTransitionDuration, firstLevel: level === 0, className: classnames(menuClasses.suffix, sharedClasses), rootStyles: getSubMenuItemStyles("suffix") }, suffix),
      React.createElement(StyledExpandIconWrapper, { rtl, className: classnames(menuClasses.SubMenuExpandIcon, sharedClasses), collapsed, level, rootStyles: getSubMenuItemStyles("SubMenuExpandIcon") }, renderExpandIcon ? renderExpandIcon({
        level,
        disabled,
        active,
        open: openControlled !== null && openControlled !== void 0 ? openControlled : open
      }) : collapsed && level === 0 ? React.createElement(StyledExpandIconCollapsed, null) : React.createElement(StyledExpandIcon, { rtl, open: openControlled !== null && openControlled !== void 0 ? openControlled : open }))
    ),
    React.createElement(
      SubMenuContent,
      ...
      React.createElement(LevelContext.Provider, { value: level + 1 }, children)
    )
  );
};
...
var MenuItemFR = function(_a, ref) {
  ...
  var level = React.useContext(LevelContext);
  var _e = React.useContext(SidebarContext), collapsed = _e.collapsed, rtl = _e.rtl, transitionDuration = _e.transitionDuration;
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      icon && React.createElement(StyledMenuIcon, { rtl, className: classnames(menuClasses.icon, sharedClasses), rootStyles: getMenuItemStyles("icon") }, icon),
      prefix2 && React.createElement(StyledMenuPrefix, { collapsed, transitionDuration, firstLevel: level === 0, className: classnames(menuClasses.prefix, sharedClasses), rtl, rootStyles: getMenuItemStyles("prefix") }, prefix2),
      React.createElement(StyledMenuLabel, { className: classnames(menuClasses.label, sharedClasses), rootStyles: getMenuItemStyles("label") }, children),
      suffix && React.createElement(StyledMenuSuffix, { collapsed, transitionDuration, firstLevel: level === 0, className: classnames(menuClasses.suffix, sharedClasses), rootStyles: getMenuItemStyles("suffix") }, suffix)
    )
  );
};
