...
import { t as resolveManifestAssetLink, l as rootRouteId, w as getNormalizedURL, x as getOrigin, y as attachRouterServerSsrUtils, z as defineHandlerCallback, A as createSerializationAdapter, C as createRawStreamRPCPlugin, i as invariant, g as isNotFound, m as isRedirect, D as isResolvedRedirect, E as mergeHeaders, F as executeRewriteInput, G as defaultSerovalPlugins, H as makeSerovalPlugin } from "../_libs/tanstack__router-core.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B0ch3sNd.mjs");
...
async function loadEntries() {
  const routerEntry = await import("./router-Q-XFCkFr.mjs").then((n) => n.r);
  return {
