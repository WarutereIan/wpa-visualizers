...
import { CONTACT_EMAIL, whatsappUrl, WHATSAPP_DEFAULT_MESSAGE } from '#/lib/contact';
...
export function FloatingContactActions({
  ...
  return (
    ...
    >
      <a
        href={`mailto:${CONTACT_EMAIL}?subject=${encodeURIComponent('DIMES-BI enquiry')}`}
        className="flex size-12 items-center justify-center rounded-full bg-slate-900 text-white shadow-lg shadow-slate-900/25 transition hover:bg-slate-800 hover:scale-105 focus:outline-none focus-visible:ring-2 focus-visible:ring-violet-500 focus-visible:ring-offset-2 dark:bg-white dark:text-slate-900 dark:hover:bg-slate-100"
