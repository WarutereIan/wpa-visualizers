import type { DateGrain } from '#/types/data'

export type { DateGrain }

/** Bucket an ISO/date-like value to a stable string key for GROUP BY. */
...
/** DuckDB expression that buckets a date/timestamp column. */
